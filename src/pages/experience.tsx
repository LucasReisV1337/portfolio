...
export default function Experience() {
  ...
  return (
    <>
      <Head>
        <title>Experience | Lucas Reis </title>
        <meta
          name="description"
          content="Minha experiência como desenvolvedor web."
        />
        <meta property="og:title" content="Experience | Lucas Reis" />
        <meta
      ...
      <Section>
        ...
        <Description>
          Sou apaixonado por criar softwares interativas e funcionais, buscando
